					...
					<div class="slider-banner-container">
						<div class="slider-banner-fullscreen">
							<ul class="slides">
								<!-- slide 1 start -->
								<!-- ================ -->
								<li data-transition="random-static" data-slotamount="7" data-delay="15000" data-masterspeed="500" data-saveperformance="on" data-title="Powerful Bootstrap Template">
								<!-- Edit data-delay to change the time between slide transition. -->
								<!-- main image -->
								...
								<div class="tp-caption sfr stl xlarge_white"
									...
									data-splitout="chars">100 Subjects
								</div>
								...
								<div class="tp-caption sfl str xlarge_white"
									...
									data-elementdelay="0.05"
									data-endelementdelay="0.03"
									data-splitout="chars">2000 Sets Of Notes
								</div>
								...
								<div class="tp-caption sft fadeout text-center large_white"
									...
									data-easing="easeOutQuad"
									data-start="6400"
									data-end="15000">NotesAcademy <br> <h5>SITE TAGLINE HERE</h5>
								</div>	
								...
								<div class="tp-caption ZoomIn fadeout text-center tp-resizeme large_white"
									...
									data-easing="easeOutQuad"
									data-start="6400"
									data-end="15000"><div class="separator light"></div>
								</div>	
								...
								<div class="tp-caption sft fadeout medium_white text-center"
									...
									data-start="5800"
									data-end="15000"
									data-endspeed="600">Lorem Ipsum text here <br><a href="#" class="btn btn-default btn-lg btn-animated">View Notes Now <i class="fa fa-book"></i></a>
								</div>
								...
								<!-- slide 2 start -->
								<!-- ================ -->
								<li data-transition="random-static" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Join Us And Share Your Knowledge!">
								...
								<div class="tp-caption sfb fadeout large_white"
									...
									data-start="1000"
									data-easing="easeOutQuad"
									data-end="10000"> Share Your Notes
								</div>	
								...
								<div class="tp-caption sfb fadeout small_white"
									...
									data-start="2500"
									data-easing="easeOutQuad"
									data-endspeed="600"><a href="contribute.php" class="btn btn-default btn-lg btn-animated">Contribute Now <i class="fa fa-upload"></i></a>
								</div>
								</li>
								<!-- slide 2 end -->
							</ul>
