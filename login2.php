																		...
																		<div class="row">
																			...
																			<div class="col-sm-4">
																				...
																				<ul class="menu">
																					...
																					<li class="active"><a href="page-login.html"><i class="fa fa-angle-right"></i>Login 1</a></li>
					...
					<div class="row">
						...
						<div class="main object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="100">
							<div class="form-block center-block p-30 light-gray-bg border-clear">
								...
								<?php if (isset($wrong)) echo "Incorrect login. Please try again.";?>
								<form class="form-horizontal" action="login_spec.php" method="POST">
									<div class="form-group has-feedback">
