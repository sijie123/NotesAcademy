				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-6 col-md-offset-3 pv-40">
							<h1 class="page-title"><span class="text-default"><i class="fa fa-frown-o"></i></span></h1>
							<?php
							$x = rand(0,5);
							switch ($x) {
								case 0:
									echo "<h2>The dog ate the notes!</h2>";
									break;
								case 1:
									echo "<h2>Notes? What notes?</h2>";
									break;
								case 2:
									echo "<h2>First 100 only. The notes are gone.</h2>";
									break;
								case 3:
									echo "<h2>I lent the notes to my friend and they never came back.</h2>";
									break;
								case 4:
									echo "<h2>I placed the notes in the microwave together with an egg.</h2>";
									break;
								case 5:
									echo "<h2>The server ran out of ink.</h2>";
									break;
								default:
							...
							?>
							<p>Something went wrong with the server.<br>Please help us by reporting this issue to contact@notesacademy.org<br>Meanwhile, aybe you might want to search for your notes?</p>
							<form role="search">
								<div class="form-group has-feedback">
									<input type="text" class="form-control" placeholder="Search">
