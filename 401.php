				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-6 col-md-offset-3 pv-40">
							<h1 class="page-title"><span class="text-default">401</span></h1>
							<?php
							$x = rand(0,5);
							switch ($x) {
								case 0:
									echo "<h2>You're looking at the answer sheet! No cheating!</h2>";
									break;
								case 1:
									echo "<h2>Shouldn't you knock before visiting this page?</h2>";
									break;
								case 2:
									echo "<h2>The password is password.</h2>";
									break;
								case 3:
									echo "<h2>I told you, the file is password protected. Nice try.</h2>";
									break;
								case 4:
									echo "<h2>The dog is barking at you for giving a wrong password.</h2>";
									break;
								case 5:
									echo "<h2>You ran out of keys. Get more before coming back.</h2>";
									break;
								default:
									echo "<h2>Oops! You entered the wrong password!</h2>";
									break;
							}
							?>
							<p>The requested URL was not found on this server.<br>Maybe you might want to search for your notes?</p>
							<form role="search">
								<div class="form-group has-feedback">
									<input type="text" class="form-control" placeholder="Search">
